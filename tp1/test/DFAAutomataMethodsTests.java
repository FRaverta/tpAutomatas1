...
public static String ruta ="";
	...
	public void test4() throws Exception {
		DFA dfa = (DFA) FA.parse_form_file(ruta +"test/dfa1.dot");
	...
	public void test5() throws Exception {
		DFA dfa = (DFA) FA.parse_form_file(ruta +"test/dfa2.dot");
	...
	public void test9() throws Exception {
		DFA dfa = (DFA) FA.parse_form_file(ruta +"test/dfa3.dot");
	...
	public void test15() throws Exception {
		DFA dfa2 = (DFA) FA.parse_form_file(ruta+"test/dfa2.dot");
		DFA dfa3 = (DFA) FA.parse_form_file(ruta+"test/dfa3.dot");
	...
	public void test17() throws Exception {
		DFA dfa = (DFA) FA.parse_form_file(ruta+"test/dfa4.dot");
